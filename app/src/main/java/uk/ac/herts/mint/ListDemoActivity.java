...
import uk.ac.herts.mint.data.PharmcyProvider;
...
public class ListDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.setAdapter(new MapAdapter(locations));
     ...
     */
    private ArrayList<NamedLocation> locations=new ArrayList<>();
    private void setListLocations(){
        for (uk.ac.herts.mint.data.PharmcyDetail pharmcyDetail:uk.ac.herts.mint.data.PharmcyProvider.getInstance().pharmcyDetails){
            String name=pharmcyDetail.name;
            Double lat=Double.parseDouble(pharmcyDetail.lat);
            Double lng=Double.parseDouble(pharmcyDetail.lng);
            LatLng latLng=new LatLng(lat,lng);
            NamedLocation namedLocation=new NamedLocation(name, latLng);
            locations.add(namedLocation);
        }

//      LIST_LOCATIONS = locations.toArray(new NamedLocation[locations.size()]);
